    ...
    render() {
        return(
            <div style={{background:'#ABB8C3'}}>
                <div className="container" style={{width:700,background:'#FF0000',color:'white'}}>
                    <h3 align="center">Add new Exam</h3>
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className="form-group">
                            <input style={{marginLeft:"250px"}} type="submit" value="Create Exam" className="btn btn-primary" />
                        </div>
                    </form>
                </div>
            </div>
