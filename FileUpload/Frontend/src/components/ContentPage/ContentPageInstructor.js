...
import Assignment from '../ExamsAssignments/assignment.add.component';
import back from "./wall.jpg";
import ExamMain from '../ExamsAssignments/exam.main.component'
            ...
            <BrowserRouter>
                <div style={secionStyle}>
                    ...
                    <div style={{
                        ...
                        <Link className="btn btn-outline-info"
                              style={{width: '400px', height: '100px', background: '', marginLeft: '60px'}}
                              to="/assignmentAdd"><h2 style={{marginTop: '35px'}}>ADD ASSIGNMENTS</h2></Link>

                        <Link className="btn btn-outline-info"
                              style={{width: '400px', height: '100px', background: '', marginLeft: '60px'}}
                              to="/assignmentAdd"><h2 style={{marginTop: '35px'}}>ASSIGNMENTS</h2></Link>

                        <Link className="btn btn-outline-info"
                              style={{width: '400px', height: '100px', background: '', marginLeft: '60px'}}
                              to="/ExamMain"><h2 style={{marginTop: '35px'}}>EXAMS</h2></Link>
                ...
                <Route path="/assignmentAdd" component={Assignment}/>
                <Route path="/ExamMain" component={ExamMain}/>
